...
import com.attendance.ui.fragments.dataupdate.AttendanceViewFragment;
...
public class StudentFragment extends BaseFragment {
    ...
    private void loadAttendData(){
        ...
        String user = prefrences.getUserName();
        ...
        AndroidNetworking.post(Constants.VIEWATTENDANCES)
