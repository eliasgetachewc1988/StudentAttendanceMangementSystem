                    ...
                    public void onResponse(JSONArray response) {
                        for (int i =0; i < response.length(); i++) {
                            ...
                            try {
                                ...
                                attendanceResult.setPercentage(json.getString("Class"));
                                ...
                                Log.d("viewat",json.getString("Rollno")+" "+ json.getString("Total") + json.getString("Class"));
                                ...
                                //if (SubjectFragment.fllag==0){b3.setText("OOP");}
                                // else if (SubjectFragment.fllag==1){b3.setText("Digital Logic");}
                                //  else if (SubjectFragment.fllag==2){b3.setText("Network Security");}
                                //  else if (SubjectFragment.fllag==3){b3.setText("Database");}
                                //   else if (SubjectFragment.fllag==4){b3.setText("Discreet Math");}
                                //  else if (SubjectFragment.fllag==5){b3.setText("OS");}
