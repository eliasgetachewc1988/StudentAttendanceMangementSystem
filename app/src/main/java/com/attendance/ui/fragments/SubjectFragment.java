...
public class SubjectFragment extends BaseFragment implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private AppCompatSpinner appCompatSpinner,appCompatSpinner1,appCompatSpinner2,appCompatSpinner3;
    ...
    public static int fllag=0;
    public static int flllag=0;
    public static int rono=1;
    ...
    private void DialogPicker(){
        ...
        //appCompatSpinner3= (AppCompatSpinner) divView.findViewById(R.id.num);
        final EditText editText = (EditText) divView.findViewById(R.id.num);
...
// Specify the type of input expected; this, for example, sets the input as a password, and will mask the text
   ...
   //     builder.setView(input);
        ...
        builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                dialogInterface.dismiss();
                FrgamentLoader();
                rono = Integer.parseInt(editText.getText().toString());
            }
        });
        builder.show();
 ...
 /*       appCompatSpinner3.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0){
                    pref.setStatus(numList.get(0));
                   flllag=1;
                }else if (position == 1){
                    pref.setStatus(numList.get(1));
                    flllag=2;
                }else if (position == 2){
                    pref.setStatus(numList.get(1));
                    flllag=3;
